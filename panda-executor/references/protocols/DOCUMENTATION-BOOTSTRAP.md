...
If missing, bootstrap from the plan's Vision and Architecture Decisions sections. Use the panda-intent skill's root template format.

**2. ARCHITECTURE.mmd** (project root)

If missing, bootstrap by scanning the codebase for modules and their import relationships. Use the panda-diagram skill's root template format.

**3. STYLE.md** (project root)

If missing, copy from `~/.claude/skills/panda-executor/references/STYLE-TEMPLATE.md` into the project root.
