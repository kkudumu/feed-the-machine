...
## Reading panda-config.yml

Read `~/.claude/panda-config.yml` to determine which models to use when spawning agents. If the file doesn't exist, use these balanced defaults:
...
## Example panda-config.yml Structure
