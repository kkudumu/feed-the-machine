...
- tool: `$CODEX_HOME/skills/ftm-browse/bin/ftm-browse` | required | headless browser CLI binary
...
- cli: `$CODEX_HOME/skills/ftm-browse/bin/ftm-browse` | required | headless Chromium control CLI
