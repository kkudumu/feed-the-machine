...
**Location**: `~/.codex/ftm-state/blackboard/`
...
**Path**: `~/.codex/ftm-state/blackboard/context.json`
...
**Path**: `~/.codex/ftm-state/blackboard/patterns.json`
...
**Directory**: `~/.codex/ftm-state/blackboard/experiences/`
...
**Path**: `~/.codex/ftm-state/blackboard/experiences/index.json`
...
```
Read: ~/.codex/ftm-state/blackboard/context.json
```
...
```
Write: ~/.codex/ftm-state/blackboard/context.json
Write: ~/.codex/ftm-state/blackboard/patterns.json
Write: ~/.codex/ftm-state/blackboard/experiences/index.json
Write: ~/.codex/ftm-state/blackboard/experiences/YYYY-MM-DD_task-slug.json
```
...
| What | Absolute Path |
|---|---|
| Session state | `~/.codex/ftm-state/blackboard/context.json` |
| Meta-patterns | `~/.codex/ftm-state/blackboard/patterns.json` |
| Experience index | `~/.codex/ftm-state/blackboard/experiences/index.json` |
| Experience files | `~/.codex/ftm-state/blackboard/experiences/YYYY-MM-DD_slug.json` |
| This document | `~/.codex/skills/ftm-mind/references/blackboard-schema.md` |
