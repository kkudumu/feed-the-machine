...
**Location**: `~/.codex/skills/ftm-mind/references/reflexion-protocol.md`
...
Written to: `~/.codex/ftm-state/blackboard/experiences/YYYY-MM-DD_task-slug.json`
...
| Experience file location | `~/.codex/ftm-state/blackboard/experiences/YYYY-MM-DD_task-slug.json` |
