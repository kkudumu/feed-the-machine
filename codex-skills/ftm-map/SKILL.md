...
1. Update `~/.codex/ftm-blackboard/context.json` with map session summary
2. Write experience file: `~/.codex/ftm-blackboard/experiences/map-[timestamp].json`
...
- config: `~/.codex/ftm-config.yml` | optional | model profile and skills.ftm-map.enabled flag
