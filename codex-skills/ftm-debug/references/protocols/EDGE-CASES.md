...
If the Reviewer literally cannot restart because it's running inside the process being fixed (e.g., debugging Codex from within Codex), try these alternatives before flagging BLOCKED:
