...
Uses `codex exec` to judge whether a skill description should trigger for a
...
def run_single_query(
    ...
    """Run a single query and return whether the description should trigger."""
...
"""
    ...
    return answer.startswith("TRIGGER")
