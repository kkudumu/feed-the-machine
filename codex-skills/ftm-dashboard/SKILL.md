...
### events.log (`~/.codex/ftm-state/events.log`)
...
### Blackboard State
- `~/.codex/ftm-state/blackboard/context.json` — current session metadata
- `~/.codex/ftm-state/blackboard/experiences/index.json` — experience counts and types
- `~/.codex/ftm-state/blackboard/patterns.json` — pattern health
...
- reference: `~/.codex/ftm-state/events.log` | optional | JSONL event log for skill invocation tracking
- reference: `~/.codex/ftm-state/blackboard/context.json` | required | current session metadata
- reference: `~/.codex/ftm-state/blackboard/experiences/index.json` | optional | experience inventory and counts
- reference: `~/.codex/ftm-state/blackboard/patterns.json` | optional | pattern health for weekly stats
