...
5. **panda-browse ($PB) for UI verification**: If panda-browse is
   ...
   **Graceful fallback**: If the binary does NOT exist at
   `$HOME/.claude/skills/panda-browse/bin/panda-browse`, fall back to
   ...
   "Visual verification skipped — panda-browse not installed."
