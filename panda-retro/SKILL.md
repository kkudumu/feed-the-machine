...
2. **Audit Pass Rate** — what percentage of tasks passed panda-audit on the first attempt?
3. **Codex Gate Pass Rate** — what percentage of waves passed the panda-codex-gate on the first attempt?
...
Write a structured experience entry to `~/.claude/panda-state/blackboard/experiences/YYYY-MM-DD_task-slug.json`.
